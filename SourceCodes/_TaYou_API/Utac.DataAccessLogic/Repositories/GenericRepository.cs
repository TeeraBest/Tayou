...
namespace Utac.DataAccessLogic.Repositories
{
    ...
    public class GenericRepository<TEntity> where TEntity : class
    {
        ...
        internal TaYou_dbEntities Context;
        ...
        public GenericRepository(TaYou_dbEntities context)
        {
        ...
        //-------------------------------------------
        /// <summary>
        /// generic Insert or update method for the entities
        /// </summary>
        /// <param name="entity"></param>
        ...
        /// </summary>
        /// <param name="entity"></param>
        public virtual void CreateListEntity(IEnumerable<TEntity> entity)
        {
        ...
        {
            return DbSet.Where(where).AsEnumerable<TEntity>();
        }
        ...
        /// <summary>
        /// generic method to fetch all the records from db by the specific criteria
        /// </summary>
        /// <returns></returns>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public virtual TEntity FindByGuid(object guid)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual TEntity FindWithExpression(System.Linq.Expressions.Expression<Func<TEntity, bool>> predicate)
        {
            return DbSet.FirstOrDefault(predicate);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public virtual IEnumerable<TEntity> FindAllWithExpression(System.Linq.Expressions.Expression<Func<TEntity, bool>> predicate)
        {
            return DbSet.Where(predicate).AsEnumerable<TEntity>();
        }
